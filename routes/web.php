...
Route::middleware(['auth'])->group(function () {
    Route::prefix('state')->name('state.')->controller(StateController::class)->group(function () {
        ...
        // This URL is for DISPLAYING the form (GET)
        Route::get('/add/{id?}', 'add')->name('add');
        
        // This URL is for SAVING the data (POST)
        // Note: I changed the URL path to 'save-data' to avoid any conflict with 'add'
        Route::post('/save-data', 'save')->name('save');
