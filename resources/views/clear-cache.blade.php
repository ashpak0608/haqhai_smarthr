                        ...
                        <div class="card-body pb-0 ">
                            <div class="cache-content">
                                <p class="fs-14 text-dark mb-3"> <span class="me-2"><i
                                            class="ti ti-info-circle text-danger"></i></span>Clearing the cache may improve
                                    performance but will remove temporary files, stored preferences, and cached data from
