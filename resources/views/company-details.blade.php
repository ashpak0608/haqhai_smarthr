    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row align-items-center mb-4">
                <div class="col-sm-6">
                    <h6 class="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0"><a href="{{url('companies-grid')}}">
                    ...
                    <div class="card card-bg-1">
                        <div class="card-body p-0">
                            <span class="avatar avatar-xl border bg-white rounded-circle m-auto d-flex mb-2">
                                <img src="{{ URL::asset('build/img/company/company-11.svg') }}" class="w-auto h-auto" alt="Img">
                            </span>
