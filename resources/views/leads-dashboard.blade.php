                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card position-relative">
                        <div class="card-body">
                            ...
                            <span class="position-absolute top-0 end-0"><img src="{{ URL::asset('build/img/bg/card-bg-04.png') }}" alt="Img"></span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                            ...
                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('build/img/company/company-24.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('build/img/company/company-25.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('build/img/company/company-26.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('build/img/company/company-27.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ URL::asset('build/img/company/company-28.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/users/user-45.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                                        <h6 class="fs-14 fw-medium text-truncate mb-1"><a href="#">Doglas Martini</a></h6>
                                        <p class="fs-13">Team Lead</p>
                        ...
                        <div class="card-body schedule-timeline activity-timeline">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill ps-3 pb-4 timeline-flow">
                                    <p class="fw-medium text-gray-9 mb-1"><a href="{{url('activity')}}">Drain responded to your appointment schedule question.</a></p>
                                    <span>09:25 PM</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill ps-3 pb-4 timeline-flow">
                                    <p class="fw-medium text-gray-9 mb-1"><a href="{{url('activity')}}">You sent 1 Message to the James.</a></p>
                                    <span>10:25 PM</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill ps-3 pb-4 timeline-flow">
                                    <p class="fw-medium text-gray-9 mb-1"><a href="{{url('activity')}}">Denwar responded to your appointment on 25 Jan 2025, 08:15 PM</a></p>
                                    <span>09:25 PM</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill ps-3 timeline-flow">
                                    <p class="fw-medium text-gray-9 mb-1"><a href="{{url('activity')}}" class="d-flex align-items-center">Meeting With <img src="{{ URL::asset('build/img/users/user-58.jpg') }}" class="avatar avatar-sm rounded-circle mx-2" alt="Img">Abraham</a></p>
                                    <span>09:25 PM</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xxl-5 col-sm-6">
                                    <div class="pe-3 border-end">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ URL::asset('build/img/payment-gateway/country-03.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="{{url('countries')}}">Singapore</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ URL::asset('build/img/payment-gateway/country-04.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="{{url('countries')}}">France</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ URL::asset('build/img/payment-gateway/country-05.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="{{url('countries')}}">Norway</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ URL::asset('build/img/payment-gateway/country-01.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="{{url('countries')}}">USA</a></h6>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="{{url('countries')}}" class="avatar rounded-circle flex-shrink-0 border border-2">
                                                <img src="{{ URL::asset('build/img/payment-gateway/country-02.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium text-truncate mb-1"><a href="{{url('countries')}}">UAE</a></h6>
                                                <span class="fs-13 text-truncate">Leads : 221</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">	
                                <table class="table table-nowrap dashboard-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('leads-details')}}">Collins</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('leads-details')}}">Konopelski</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('leads-details')}}">Adams</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('leads-details')}}">Schumm</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('leads-details')}}">Wisozk</a></h6></td>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar border rounded-circle">
