                    ...
                    <div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{ URL::asset('build/img/users/user-11.jpg') }}" alt="Img"></a>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start">
                                    <span class="avatar avatar-rounded me-2 flex-shrink-0"><img src="{{ URL::asset('build/img/users/user-11.jpg') }}" alt="Img"></span>
                                    <input type="text" class="form-control" placeholder="Enter Comments">
                                </div>
                            </div>
                        </div>
