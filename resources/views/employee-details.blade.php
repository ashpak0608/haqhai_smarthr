                                                                ...
                                                                <div class="card-body">
                                                                    <div class="d-flex align-items-center pb-3 mb-3 border-bottom">
                                                                        <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                                                            <img src="{{ URL::asset('build/img/social/project-03.svg') }}" alt="Img">
                                                                        </a>
                                                                        <div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-8">
                                                                            <div class="d-flex align-items-center">
                                                                                <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                                                                    <img src="{{ URL::asset('build/img/products/product-05.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                                                </a>
                                                                                <div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-md-8">
                                                                            <div class="d-flex align-items-center">
                                                                                <a href="{{url('project-details')}}" class="flex-shrink-0 me-2">
                                                                                    <img src="{{ URL::asset('build/img/products/product-06.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                                                </a>
                                                                                <div>
