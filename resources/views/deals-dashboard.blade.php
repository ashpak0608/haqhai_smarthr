                    ...
                    <div class="card flex-fill">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                ...
                                <div>
                                    <a href="{{url('countries') }}" class="btn btn-light btn-sm px-3">View All</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    <a href="{{url('countries')}}" class="avatar rounded-circle border border-2">
                                                        <img src="{{ URL::asset('build/img/payment-gateway/country-01.svg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-1"><a href="{{url('countries')}}">USA</a></h6>
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-1"><a href="{{url('countries')}}">UAE</a></h6>
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-1"><a href="{{url('countries')}}">Singapore</a></h6>
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-1"><a href="{{url('countries')}}">France</a></h6>
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-1"><a href="{{url('countries')}}">Norway</a></h6>
                                                        <span class="fs-13 d-inline-flex align-items-center">Deals : 221</span>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">	
                                <table class="table table-nowrap dashboard-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('deals-details')}}">Collins</a></h6></td>
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('deals-details')}}">Konopelski</a></h6></td>
                                            <td>Proposal Made</td>
                                            <td>
                                                $3,15,000
                                            </td>
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('deals-details')}}">Adams</a></h6></td>
                                            <td>Contact Made</td>
                                            <td>
                                                $8,40,000
                                            </td>
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('deals-details')}}">Schumm</a></h6></td>
                                            <td>Quality To Buy</td>
                                            <td>
                                                $6,10,000
                                            </td>
                                        ...
                                        <tr>
                                            <td><h6 class="fw-medium"><a href="{{url('deals-details')}}">Wisozk</a></h6></td>
                                            <td>Presentation</td>
                                            <td>
                                                $4,70,000
                                            </td>
